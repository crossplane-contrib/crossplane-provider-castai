...
export TERRAFORM_PROVIDER_VERSION ?= 8.31.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-castai
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-castai_v8.31.0
...
ifndef SKIP_SCHEMA_REGEN
	...
	@$(INFO) skipping schema regen, using existing $(TERRAFORM_PROVIDER_SCHEMA)
endif
