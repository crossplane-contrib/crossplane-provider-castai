...
type RebalancingJobInitParameters struct {
	...
	// CAST AI cluster id.
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/crossplane-provider-castai/apis/cluster/castai/v1alpha1.EksClusterId
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/crossplane-provider-castai/apis/cluster/castai/v1alpha1.RebalancingSchedule
	...
	// +kubebuilder:validation:Optional
	RebalancingScheduleIDRef *v1.NamespacedReference `json:"rebalancingScheduleIdRef,omitempty" tf:"-"`

	// Selector for a RebalancingSchedule in castai to populate rebalancingScheduleId.
	// +kubebuilder:validation:Optional
	RebalancingScheduleIDSelector *v1.NamespacedSelector `json:"rebalancingScheduleIdSelector,omitempty" tf:"-"`
}
