...
type ScalingPolicyOrderInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/crossplane-provider-castai/apis/cluster/castai/v1alpha1.ScalingPolicy
	...
	PolicyIdsRefs []v1.NamespacedReference `json:"policyIdsRefs,omitempty" tf:"-"`

	// Selector for a list of ScalingPolicy in castai to populate policyIds.
	// +kubebuilder:validation:Optional
	PolicyIdsSelector *v1.NamespacedSelector `json:"policyIdsSelector,omitempty" tf:"-"`
}
