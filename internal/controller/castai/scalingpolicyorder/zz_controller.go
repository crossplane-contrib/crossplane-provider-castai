...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	opts := []managed.ReconcilerOption{
		managed.WithExternalConnecter(tjcontroller.NewConnector(mgr.GetClient(), o.WorkspaceStore, o.SetupFn, o.Provider.Resources["castai_workload_scaling_policy_order"], tjcontroller.WithLogger(o.Logger), tjcontroller.WithConnectorEventHandler(eventHandler),
	...
	// register webhooks for the kind v1alpha1.ScalingPolicyOrder
	// if they're enabled.
	if o.StartWebhooks {
		if err := ctrl.NewWebhookManagedBy(mgr).
			For(&v1alpha1.ScalingPolicyOrder{}).
			Complete(); err != nil {
			return errors.Wrap(err, "cannot register webhook for the kind v1alpha1.ScalingPolicyOrder")
		}
	}

	if o.MetricOptions != nil && o.MetricOptions.MRStateMetrics != nil {
		stateMetricsRecorder := statemetrics.NewMRStateRecorder(
			mgr.GetClient(), o.Logger, o.MetricOptions.MRStateMetrics, &v1alpha1.ScalingPolicyOrderList{}, o.MetricOptions.PollStateMetricInterval,
		)
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		Watches(&v1alpha1.ScalingPolicyOrder{}, eventHandler).
